...
public:
  ...
  Crisps() = default;
  Crisps(int line0, int line1, int line2, int line3, int motor0, int motor1, Ultrasound &ultraBlock, Ultrasound &ultraTunnel) : lineFollower1(line0), // this is the line follower on the left for following the main line
